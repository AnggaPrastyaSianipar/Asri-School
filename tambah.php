    ...
    <div class="container card mt-5 p-5 d-flex justify-content-center">
        ...
        <form method="POST" action="tambah_proses.php" enctype="multipart/form-data" >
          ...
          <div>
            ...
            <input class="form-control m-1" type="text" name="nama"/>
          </div>

          <div>
            <br>
            <label>Id Pengadu : </label>
            <input class="form-control m-1" type="text" name="npm" />
          </div>

          <!-- Buatlah div lalu isi dengan LABEL (OPSIONAL) dan Form input dengan class 'form-control' lalu beri margin 1 -->
          <div>
    <td><label for="tgl">Tanggal Pengaduan : </label></td>
    <td><input type="date" class="form-control" id="tgl" name="tgl" required max="<?php echo date('Y-m-d'); ?>"></td>
</div>
          ...
          <div>
            ...
            <a class="btn btn-primary m-1" href="team.php">Kembali</a>
          </div>
